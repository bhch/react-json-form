...
function FormInput(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", null, label && /*#__PURE__*/React__default["default"].createElement("label", null, label), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "rjf-input-group"
  }, /*#__PURE__*/React__default["default"].createElement("input", props), help_text && /*#__PURE__*/React__default["default"].createElement("span", {
...
function FormCheckInput(_ref2) {
  ...
  }, /*#__PURE__*/React__default["default"].createElement("label", null, /*#__PURE__*/React__default["default"].createElement("input", props), " ", label), help_text && /*#__PURE__*/React__default["default"].createElement("span", {
    className: "rjf-help-text"
  }, help_text));
}
function FormRadioInput(_ref3) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: "rjf-check-input"
  }, /*#__PURE__*/React__default["default"].createElement("label", null, label), options.map((option, i) => {
...
class FormTextareaInput extends React__default["default"].Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", null, label && /*#__PURE__*/React__default["default"].createElement("label", null, label), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "rjf-input-group"
    }, /*#__PURE__*/React__default["default"].createElement("textarea", props), help_text && /*#__PURE__*/React__default["default"].createElement("span", {
      className: "rjf-help-text"
    }, help_text)));
  }
...
class FormDateTimeInput extends React__default["default"].Component {
  ...
  render() {
    ...
    }, this.props.label && /*#__PURE__*/React__default["default"].createElement("label", null, this.props.label), /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    })))), this.props.help_text && /*#__PURE__*/React__default["default"].createElement("span", {
      className: "rjf-help-text"
...
class FileUploader extends React__default["default"].Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", null, this.props.label && /*#__PURE__*/React__default["default"].createElement("label", null, this.props.label), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "rjf-file-field"
    ...
    }, this.props.value ? 'Change file' : 'Select file'), this.props.help_text && /*#__PURE__*/React__default["default"].createElement("span", {
      className: "rjf-help-text"
    }, this.props.help_text)), /*#__PURE__*/React__default["default"].createElement(ReactModal__default["default"], {
  ...
  constructor(..._args) {
    ...
    this.getFields = () => {
      ...
      try {
        ...
        console.log(error);
        formGroups = /*#__PURE__*/React__default["default"].createElement("p", {
          style: {
            color: '#f00'
          }
        }, /*#__PURE__*/React__default["default"].createElement("strong", null, "(!) Error:"), " Schema and data structure do not match.");
      }
